...
\gw detectors are operated at a dark fringe (i.e.~the interferometer is held, so as the light
...
which to demodulate the \gw sidebands. However the demodulation will introduce a beat
between the RF and the \gw frequency, which must be remove by a second
