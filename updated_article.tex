...
decommisioning began in preparation for the installation of Advanced LIGO.
...
detectors were senstive and stable enough (or had made sufficient improvments
...
plane, so that the antenna repsonse is at its maximum) 1.4\,M$_{\odot}$ neutron stars,
...
2010, at which point decommisioning started for the full upgrade to AdvLIGO. 
...
Plans for the 
GEO~600 detector are to continue to use it as a test-bed for more
...
place since spring 2009. The main upgrades completed during 2009 were to change 
...
finally increasing the input laser power to 35~W. GEO-HF paticipated in S6 in an
overnight and weekend mode, along side a commisioning schedule, and is continuing
in this mode following the end of S6.
...
the initial Virgo design sensitvity were reached. VSR2 finished on 8 January 2010
to allow for further commisioning and noise hunting. This has since been followed
...
Move externally triggered stuff here e.g. GRB searches, SGR searches and Vela 
glitch \cite{Abadie:2010a} search. Say about follow-ups and MoUs with Swift, 
neutrino detectors, optical telescopes etc. 
