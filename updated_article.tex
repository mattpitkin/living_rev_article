...
location, and likely adopt a xylophone configuration (two independent interferometers
covering different frequency ranges)~\cite{Punturo:2010}.  The high-frequency interferometer configuration
is expected to be an up-scaled version of Advanced LIGO, using 200~kg silica mirror test masses suspended from
silica fibres.  The low-frequency setup will likely require the use of cryogenics to minimise thermal noise and is therefore expected to
be constructed from quasi-monolithic silicon mirror suspensions~\cite{Rowan:2003}.
