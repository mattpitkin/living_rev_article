...
\epubtkImage{figures/full_gw_spectrum/fig1.png}{%
\begin{figure}[htbp]
  \centerline{\includegraphics[width=0.8\textwidth]{fig1}}
  \caption[]{\input{figures/fig1/caption}}
\end{figure}}

\input{Section3_2}

\epubtkImage{figures/full_gw_spectrum/fig2.png}{%
\begin{figure}[htbp]
  \centerline{\includegraphics[width=0.5\textwidth]{fig2}}
  \caption[]{\input{figures/fig2/caption}}
\end{figure}}
...
\begin{figure}[htbp]
  ...
  \caption{\input{figures/LIGOsens/LIGOsens}}
\end{figure}}
