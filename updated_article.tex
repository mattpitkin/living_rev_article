...
Over the last decade the commisioning and improvement of the various gravitational 
...
Taking} (DT) periods. A timeline of science runs for the various interferometric 
...
Collaboration \cite{LSCweb} detectors LIGO and GEO~600 from S1 to the S6 run. 
...
Another targeted search was performed with 12 days of S5 data, although this time
