...
For the first and second generation of detector much effort has gone into estimating
the expected number of sources that might be observable. In particular, for what are
...
estimates). Second generation detectors (see \S\ref{subsection:aligo}), which can observe approximately 
1000 time more volume than the initial detectors might expect to see 40, 10, and 20
per year for the same sources\footnote{In terms of event rates the current best 
...
can be seen in Figure 3 of \cite{Abbott:2008a}.}. With such rates a great deal of astrophysics could be
...
they gave a 90\% confidence upper limit of $\Omega_{\rm gw} < 44\pm9$ within
...
{\it total} energy density of the universe of $\Omega_0\approx1$.
