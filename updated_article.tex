...
world -- LIGO (USA), Virgo (Italy/France), TAMA~300 and LCGT (Japan), and
GEO~600 (Germany/U.K.) -- and in LISA, a proposed space-borne interferometer. A
...
completed over the coming years, which will create the first network of
detectors with the sensitivity required to detect gravitational waves.  Beyond
this, the concept and design of possible future ``third generation''
...
1064 nm and the expected low absorption (less that 0.1 ppm/cm) at around 1550
...
two detectors as described in \cite{Allen:1999}.
