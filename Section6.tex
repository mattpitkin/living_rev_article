...
By mid-to-late 2005 the detectors had equalled their design sensitivities over most of the frequency band and 
...
Two of the most important externally triggered searches during the initial detector era were for two short GRBs: \epubtkSIMBAD{GRB~070201}~\cite{Golenetskii:2007a,Golenetskii:2007b} and 
\epubtkSIMBAD{GRB~051103}~\cite{2005GCN..4197....1G}. These both had potential visual
associations with local galaxies; \epubtkSIMBAD{M31} for \epubtkSIMBAD{GRB~070201}, and \epubtkSIMBAD{M81} for
\epubtkSIMBAD{GRB~051103}. Assuming that the visual associations were true the non-detection of gravitational
...
During the initial detector era efforts were also undertaken to invert the process of searching gravitational-wave data for external 
...
The various search techniques used all look for statistically-significant excess 
...
gave a 90\% confidence upper limit of $\Omega_{\mathrm{gw}} < 44\pm9$ within the 40\,--\,314~Hz band,\epubtkFootnote{The
result published in~\cite{Abbott:2004e} gives an upper limit value of
...
\cite{Abbott:2005h}.} where the upper limit is in
...
Using LIGO S6 and Virgo VSR2/3 data the most stringent limits on the energy density
...
Advanced LIGO (aLIGO) consists of two 4~km detectors in the initial LIGO vacuum system. It will applies some of the
...
GW150914 was followed up with electromagnetic observations~\cite{2016ApJ...826L..13A}, and coincident neutrino triggers were searched
...
BBH mergers has been constrained with these observations to be 9--240~Gpc\super{-3}~yr\super{-1} (see also \cite{rates, ratessup} for the rate
...
and 110~Mpc for BNS and NSBH systems respectively. This also set rates limits of 12\,600~Gpc\super{-3}~yr\super{-1} and
3\,600~Gpc\super{-3}~yr\super{-1} for BNS and NSBH systems respectively.
...
detectors in total, although constructed over a period of years).
...
This would aim to have 40~km arms and be more sensitive than ET designs above $\sim 10$~Hz.

Three potential ET sensitivity curves and the ``Cosmic Explorer'' sensitivity curve are plotted in
Figure~\ref{fig:etsens}.