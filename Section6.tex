...
polarisaion constraints) in LIGO S5 and Virgo VSR1 data was performed to look for intermediate mass binary 
black holes in the total mass range $100$\,--\,$450\,M_{\odot}$ with mass ratios between 1:1 and 
...
All initial LIGO and Virgo data collected between 2005 and 2011 was used to search for ring-down signals from 
perturbed intermediate mass black holes (IMBHs) \cite{2014PhRvD..89j2006A}. The search targeted systems for 
which total mass of the binary producing the perturbed IMBH was between $50$\,--\,$450\,M_{\odot}$, and 
(similarly to \cite{2012PhRvD..85j2004A}) mass ratios of between 1:1 and 4:1. The most stringent 90\% 
confidence rate upper limit was set for non-spinning, equal mass IMBH mergers with total masses between 
$100$\,--\,$150\,M_{\odot}$, at 6.9~\texttimes~10\super{-8} per Mpc\super{-3} per year.
...
Searches have also been performed for 196 long and 27 short GRBs detected by the InterPlanetary Network (IPN) 
\cite{2003AIPC..662..473H} and coindince with initial LIGO and Virgo data taken between 2005 and 2010 
\cite{2014PhRvL.113a1102A}. For an unmodelled signal search, and using an optimistic emission energy of 
10\super{-2} $M_{\odot}c^2$ at 150~Hz, this provided a median lower limit on the source distances of 13~Mpc. 
Just taking the 27 short GRBS, and searching for BNS and NSBH signals from them, placed median source 
distance limits of 12~Mpc and 22~Mpc respectively.
