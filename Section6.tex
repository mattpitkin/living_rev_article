...
detector era, along with updated signal rate estimates for coalescencing binary neutron star systems is given 
...
\epubtkSIMBAD{SN~1987A}~\cite{Niebauer:1993}. However, since the start of science data taking for the large 
scale detectors there has been a
...
be no contribution from real signals\epubtkFootnote{This is a slight simplification. In reality time slides 
can cause a real signal to line up with an instrumental noise glitch in the other detector giving a larger 
background rate than might be na\"{i}vely expected, e.g.\ compare the two background distributions given in 
Figure~3 of \cite{2012PhRvD..85h2002A}, one with a \textit{fake} astrophysical signal kept in the time 
slides and one with it removed from time slides. The estimation of background, and the question of keeping 
potentially true signals in the time slides when performing background estimates, is discussed in detail in 
