...
\begin{figure}[hptb]
  ...
  \caption{\it Measured sensitivity of the initial LIGO interferometers during
the S5 science run (see \S\ref{sec:ligoruns}). Reproduced with permission from
\cite{LIGOcurves}.}
...
\begin{figure}[hptb]
  ...
  \caption{\it Internal stages of the large chamber seismic isolation system
...
\begin{figure}[hptb]
  ...
  \caption{\it CAD drawing of quad suspension system for Advanced LIGO, showing
...
\begin{figure}[hptb]
  ...
  \caption{\it Time-lapsed schematic illustrating the fluctuating gravitational
...
\epubtkImage{}{%
\begin{figure}[hptb]
  \centerline{\includegraphics[width=400pt]{monolithic_small}}
  \caption{\it Monolithic silica suspension of (a) GEO600 6 kg mirror test mass
...
\begin{figure}[hptb]
  ...
  \caption{\it The implementation of power recycling on a
...
\begin{figure}[hptb]
  ...
  \caption{\it The implementation of signal recycling on a
    Michelson interferometer with Fabry-Perot cavities.}
...
%discussed in \S\ref{subsection:powerrec} it is necessary that at the
...
%laser light as described in \S\ref{subsubsection:lasernoise}~\cite{Willke}.
...
\begin{figure}[hptb]
  ...
  \caption{\it The typical strain sensitivities from the GEO600 science runs S1
...
black hole search was set at 40\Msun for S3 and 80\Msun for S4. At peak in the
...
search was sensitive to ring-downs from 10--500\,M$_{\odot}$ black holes out to
...
unpolarised signal around the most sensitive region at  $\sim250$~Hz of $h_{\rm
...
concordance $\Lambda$CDM cosmology value of the {\it total} energy density of
...
\begin{figure}[hptb]
  ...
  \caption{\it A design sensitivity amplitude spectral density curve for LISA
